...
echo "\033[1;97m════════════════════════════════════════════════\n";
// In menu lựa chọn
echo "\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mNhập \033[1;31m1 \033[1;33mđể vào \033[1;34mTool Shoppe\033[1;33m\n"; 
...
echo "\033[1;97m════════════════════════════════════════════════\n";
echo "\033[1;32m🚀 Đăng nhập thành công! Đang vào Tool Shoppe...\n";
sleep(1);

// Hàm chọn tài khoản Shoppe
function chonacc() {
    global $headers;
    $json_data = array();
    $response = file_get_contents('https://gateway.golike.net/api/shopee-account', false, stream_context_create([
        'http' => [
            'method' => 'GET',
...
function nhannv($account_id) {
    ...
    $json_data = array();
    $url = 'https://gateway.golike.net/api/advertising/publishers/shopee/jobs?' . http_build_query($params);
    $response = file_get_contents($url, false, stream_context_create([
        'http' => [
            'method' => 'GET',
            'header' => buildHeaders($headers),
...
function hoanthanh($ads_id, $account_id) {
    ...
    $response = @file_get_contents('https://gateway.golike.net/api/advertising/publishers/shopee/complete-jobs', false, $context);
...
function baoloi($ads_id, $object_id, $account_id, $loai) {
    ...
    $response = file_get_contents('https://gateway.golike.net/api/advertising/publishers/shopee/skip-jobs', false, stream_context_create([
        'http' => [
            'method' => 'POST',
            'header' => buildHeaders($headers),
            'content' => json_encode($json_data)
...
// Lấy danh sách tài khoản shopee
$chontk_shopee = chonacc();

// Hiển thị danh sách tài khoản
function dsacc() {
    global $chontk_shopee;
    while (true) {
        try {
            if ($chontk_shopee["status"] != 200) {
            ...
            echo "\033[1;97m[\033[1;91m❣\033[1;97m]\033[1;97m Địa chỉ Ip\033[1;32m  : \033[1;32m☞\033[1;31m♔ \033[1;32m83.86.8888\033[1;31m♔ \033[1;97m☜\n";
            echo "\033[1;97m════════════════════════════════════════════════\n";
            echo "\033[1;97m[\033[1;91m❣\033[1;97m]\033[1;33m Danh sách acc Shoppe : \n";
            echo "\033[1;97m════════════════════════════════════════════════\n";
            for ($i = 0; $i < count($chontk_shopee["data"]); $i++) {
                echo "\033[1;36m[".($i + 1)."] \033[1;36m✈ \033[1;97mID\033[1;32m㊪ :\033[1;93m ".$chontk_shopee["data"][$i]["shopee_username"]." \033[1;97m|\033[1;31m㊪ :\033[1;32m Hoạt Động\n";
            }
            echo "\033[1;97m════════════════════════════════════════════════\n";
            break;
        } catch (Exception $e) {
            echo "\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32m".json_encode($chontk_shopee)."\n";
            sleep(10);
        }
    }
}
...
// Chọn tài khoản Shoppe
$d = 0;
while (true) {
    echo "\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mNhập \033[1;31mID Acc Shoppe \033[1;32mlàm việc: ";
    $idacc = trim(fgets(STDIN));
    for ($i = 0; $i < count($chontk_shopee["data"]); $i++) {
        if ($chontk_shopee["data"][$i]["shopee_username"] == $idacc) {
            $d = 1;
            $account_id = $chontk_shopee["data"][$i]["id"];
            break;
        }
    }
    if ($d == 0) {
...
// Nhập số job fail để đổi acc Shoppe
while (true) {
    try {
        echo "\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mSố job fail để đổi acc Shoppe (nhập 1 nếu k muốn dừng) : ";
